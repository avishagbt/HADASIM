    ...
    <div style={{ position: 'relative' }}>
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.7rem', fontWeight: 600, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.08em' }}> פעולות</div>
          <button className="btn btn-secondary" onClick={changeLocation} style={{ fontSize: '0.8rem', padding: '0.45rem 0.9rem' }}> שינוי מיקומים</button>
          <button className="btn btn-danger" onClick={changeToFarLocation} style={{ fontSize: '0.8rem', padding: '0.45rem 0.9rem' }}> הרחקת תלמידה אקראית</button>
          <button className="btn btn-ghost" onClick={goBack} style={{ fontSize: '0.8rem', padding: '0.45rem 0.9rem' }}> ← חזרה</button>
        </div>
      </div>
